...
- Keep feature code under `composeApp/src/commonMain/kotlin/com/strive/battleships/<feature>/`.
...
- Wire feature dependencies in `composeApp/src/commonMain/kotlin/com/strive/battleships/di/AppComponent.kt`.
